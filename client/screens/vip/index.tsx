    ...
    <View style={styles.tabContent}>
      ...
      <View style={styles.comparisonSection}>
        <View style={styles.comparisonHeader}>
          ...
          <Text style={styles.comparisonSubtitle}>选择适合您的套餐</Text>
        </View>
        <View style={styles.comparisonTable}>
          <View style={styles.comparisonRow}>
            <Text style={styles.comparisonFeatureText}>功能</Text>
            <Text style={styles.comparisonCellText}>基础版</Text>
            <Text style={styles.comparisonCellText}>专业版</Text>
            <Text style={styles.comparisonCellText}>尊享版</Text>
          </View>
          {[
            ...
            <View key={idx} style={[styles.comparisonRow, idx % 2 === 1 && { backgroundColor: '#14141A' }]}>
              <Text style={styles.comparisonFeatureText}>{row.name}</Text>
              <Text style={styles.comparisonCellText}>{row.basic}</Text>
              <Text style={styles.comparisonCellText}>{row.pro}</Text>
              <Text style={styles.comparisonCellText}>{row.vip}</Text>
            </View>
          ))}
        </View>
      </View>
      ...
      <View style={styles.faqSection}>
        <View style={styles.faqHeader}>
          <Text style={styles.comparisonTitle}>常见问题</Text>
        </View>
        {[
